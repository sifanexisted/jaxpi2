...
def get_base_config():
    ...
    loss_weighting.strategy = "constant"  # "constant" or "constant", constant means fixed weights
    ...
    pseudo_time.strategy = "constant"  # "dynamic" or "constant" constant means fixed weights not updated during training
